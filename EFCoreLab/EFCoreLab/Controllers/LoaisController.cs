...
namespace EFCoreLab.Controllers
{
    public class LoaisController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("MaLoai,TenLoai,MoTa")] Loai loai)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MaLoai,TenLoai,MoTa")] Loai loai)
        {
            if (id != loai.MaLoai)
            {
                return NotFound();
